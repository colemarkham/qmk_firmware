 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Adjust| Ctrl | Ctrl-Alt  | Alt  |Lower | Cmd  |Space |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = KEYMAP( \
  ...
  ADJUST,  KC_LCTL, LCTL(KC_LALT), KC_LALT, LOWER,   KC_LGUI,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
